            ...
            if (!Page.IsPostBack)
            {
                ...
                {                    
                    if (Request.QueryString["ReportID"] != null)
                    {
                        ...
                        switch (strReportID)
                        {
                            case "ReportInventario":
                                ...
                                try
                                {
                                    ...
                                    List<ProductoExistenciaModel> Existencias = new ProductoBL().ObtenerExistenciaPorTienda(0, CentroId, CustomHelper.getUserId(), -1, false, true);
                            ...
                            case "ReportCierre":
                                ...
                                try
                                {
                                    ...
                                    DeliveryREntities ddb = new DeliveryREntities();
                                    List<sp_cuentaporcobrar_historico_Result> cm = new List<sp_cuentaporcobrar_historico_Result>();
                                    cm = ddb.sp_cuentaporcobrar_historico(CentroId, FechaInicial, FechaFinal).ToList();
                                    ...
                                    Usuario = CustomHelper.getUsuarioNombre();
                                    Rol = new RolBL().ObtenerPermisoPorUsuario(CustomHelper.getUserId());
                                    Reports = "~/Reports/ReportCxCHist.rdlc";
                                }
                                catch (Exception)
                                {}
                            ...
                            //strReportID.Equals("ReportComparativaSucursal") ||
                            case "ReportComparativaSucursal":
                                ...
                                try
                                {
                                    ...
                                    DeliveryREntities ddb = new DeliveryREntities();
                                    List<sp_ventascomparativa_Result> cm = new List<sp_ventascomparativa_Result>();
                                    cm = ddb.sp_ventascomparativa(FechaInicial, FechaFinal).ToList();
                                    ...
                                    Usuario = CustomHelper.getUsuarioNombre();
                                    Rol = new RolBL().ObtenerPermisoPorUsuario(CustomHelper.getUserId());
                                    Reports = "~/Reports/ReportComparativaSucursal.rdlc";
                                }
                                catch (Exception)
                                {}

                                break;
                            case "ReportVendedoresComparativa":
                                ...
                                try
                                {
                                    ...
                                    DeliveryREntities ddb = new DeliveryREntities();
                                    List<sp_ventasxvendedor_cons_det_Result> cm = new List<sp_ventasxvendedor_cons_det_Result>();
                                    cm = ddb.sp_ventasxvendedor_cons_det( FechaInicial, FechaFinal).ToList();
                                    ...
                                    Usuario = CustomHelper.getUsuarioNombre();
                                    Rol = new RolBL().ObtenerPermisoPorUsuario(CustomHelper.getUserId());
                                    Reports = "~/Reports/ReportVendedoresComparativa.rdlc";
                                }
                                catch (Exception)
                                {}
                                ...
                                try
                                {
                                    ...
                                    DeliveryREntities ddb = new DeliveryREntities();
                                    List<sp_ventasporproductotop_Result> cm = new List<sp_ventasporproductotop_Result>();
                                    cm = ddb.sp_ventasporproductotop(CentroId, FechaInicial, FechaFinal).ToList();
                                    if (CentroId == 0)
                                    {
                                        Agencia = "Todas las Agencias";
                                    }
                                    ...
                                    Usuario = CustomHelper.getUsuarioNombre();
                                    Rol = new RolBL().ObtenerPermisoPorUsuario(CustomHelper.getUserId());
                                    Reports = "~/Reports/ReporteProductosTop.rdlc";
                                }
                                catch (Exception)
                                {}

                                break;
                            case "ReportTransporteConsolidado":
                                ...
                                try
                                {
                                    ...
                                    DeliveryREntities ddb = new DeliveryREntities();
                                    List<sp_despachosportransporte_fecha_Result> cm = new List<sp_despachosportransporte_fecha_Result>();
                                    cm = ddb.sp_despachosportransporte_fecha(CentroId, FechaInicial, FechaFinal).ToList();
                                    if (CentroId == 0)
                                    {
                                        Agencia = "Todas las Agencias";
                                    }
                                    ...
                                    Usuario = CustomHelper.getUsuarioNombre();
                                    Rol = new RolBL().ObtenerPermisoPorUsuario(CustomHelper.getUserId());
                                    Reports = "~/Reports/ReportTransporteConsolidado.rdlc";
                                }
                                catch (Exception)
                                {}

                                break;
                            case "ReportVentasDespachadas":
                                ...
                                try
                                {
                                    ...
                                    DeliveryREntities ddb = new DeliveryREntities();
                                    List<sp_ventas_despachadas_por_dia_Result> cm = new List<sp_ventas_despachadas_por_dia_Result>();
                                    cm = ddb.sp_ventas_despachadas_por_dia(CentroId, FechaInicial, FechaFinal).ToList();
                                    if (CentroId == 0)
                                    {
                                        Agencia = "Todas las Agencias";
                                    }
                                    ...
                                    Usuario = CustomHelper.getUsuarioNombre();
                                    Rol = new RolBL().ObtenerPermisoPorUsuario(CustomHelper.getUserId());
                                    Reports = "~/Reports/ReportVentasDespachadas.rdlc";
                                }
                                catch (Exception)
                                {}
                                ...
                                try
                                {
                                    ...
                                    DeliveryREntities ddb = new DeliveryREntities();
                                    List<sp_recibos_anulados_Result> cm = new List<sp_recibos_anulados_Result>();
                                    cm = ddb.sp_recibos_anulados(CentroId, FechaInicial, FechaFinal).ToList();
                                    ...
                                    Usuario = CustomHelper.getUsuarioNombre();
                                    Rol = new RolBL().ObtenerPermisoPorUsuario(CustomHelper.getUserId());
                                    Reports = "~/Reports/ReportRecibosAnulados.rdlc";
                                }
                                catch (Exception)
                                {}
                        ...
                        if (strReportID.Equals("ReportProductosTop") || strReportID.Equals("ReportComparativaSucursal") || strReportID.Equals("ReportVendedoresComparativa") || strReportID.Equals("ReportTransporteConsolidado") || strReportID.Equals("ReportRecibosAnulados") || strReportID.Equals("ReportKpiDelivery")|| strReportID.Equals("ReportCxCHist") || strReportID.Equals("ReportVentasDespachadas"))
                        {
                        ...
                        else if (strReportID.Equals("ReportProductosTop") || strReportID.Equals("ReportComparativaSucursal") || strReportID.Equals("ReportVendedoresComparativa") || strReportID.Equals("ReportTransporteConsolidado") || strReportID.Equals("ReportRecibosAnulados") || strReportID.Equals("ReportKpiDelivery")|| strReportID.Equals("ReportTopClientes") || strReportID.Equals("ReportCxCHist") || strReportID.Equals("ReportVentasDespachadas"))
                        {
