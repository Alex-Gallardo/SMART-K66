/* Amplía la descripción del permiso existente de anulación.
   Destino: POS-SmartK66. Ejecute el archivo completo en SSMS.
...
IF DB_NAME() <> N'POS-SmartK66'
    THROW 58000, 'SEGURIDAD: script autorizado únicamente para POS-SmartK66.', 1;
IF OBJECT_ID(N'dbo.Permiso', N'U') IS NULL
    THROW 58001, 'Falta dbo.Permiso. Ejecute primero la configuración base.', 1;
...
BEGIN TRY
    ...
    IF (SELECT COUNT_BIG(*) FROM dbo.Permiso
        ...
        THROW 58002, 'Se esperaba exactamente un permiso Control.BorradorNC.Anular.', 1;
    ...
    IF EXISTS (
        ...
        THROW 58003, 'El permiso Anular tiene una definición inesperada.', 1;
