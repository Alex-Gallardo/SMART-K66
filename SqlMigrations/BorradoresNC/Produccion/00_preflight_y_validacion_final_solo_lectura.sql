/* =============================================================================
   BORRADORES NC — PREFLIGHT Y VALIDACION FINAL DE SOLO LECTURA
   Destino autorizado: POS-SmartK66_DEV (PRODUCCION)

   Objetivo
   --------
   Confirmar el estado real de objetos, columnas, índices, permisos, menú,
   roles, empresas y series antes y después del despliegue de producción.

   Cómo ejecutarlo
   ---------------
   1. Abra una ventana NUEVA en SSMS.
   2. Confirme que está conectado al servidor de producción.
   3. Ejecute el archivo COMPLETO, sin seleccionar bloques parciales.
   4. No edite la línea USE: el guard clause exige POS-SmartK66_DEV.
...
BEGIN
    THROW 51000, 'SEGURIDAD: este diagnostico solo esta autorizado para POS-SmartK66_DEV.', 1;
END;
GO
