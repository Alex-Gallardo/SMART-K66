/* =============================================================================
   ...
   03_crear_adjuntos_seguro.sql y tras realizar pruebas desde la aplicacion.
   ============================================================================= */
...
BEGIN
    THROW 51420,
          'SEGURIDAD: este diagnostico solo esta autorizado para POS-SmartK66_DEV.',
          1;
END;
GO
...
PRINT N'OK: diagnostico de adjuntos finalizado en POS-SmartK66_DEV.';
GO
